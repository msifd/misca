...
public class TessellatorEx {
    public static final TessellatorEx INSTANCE = new TessellatorEx();
    ...
    public TesselatorVertexState getVertexState(float x, float y, float z) {
        ...
        PriorityQueue priorityqueue = new PriorityQueue(this.rawBufferIndex, new QuadComparator(this.rawBuffer, x + (float) this.xOffset, y + (float) this.yOffset, z + (float) this.zOffset));
        byte b0 = 32;
        int i;
    ...
    public void func_154352_a(byte r, byte g, byte b) {
        this.setColorOpaque(r & 255, g & 255, b & 255);
    }
