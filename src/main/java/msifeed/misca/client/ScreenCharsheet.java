...
public class ScreenCharsheet extends MellowScreen {
    ...
    public void initGui() {
        ...
        UiBuilder.of(container)
                ...
                .beginGroup()
                    .add(new LabelTr("gui.misca.charsheet.name")).size(30, lineHeight).below().move(0, 10, 0)
                    .add(nameInput).right().move(0, -2, 0)
                    .centerGroup(Direction.HORIZONTAL)
                    .pinGroup()
                .beginGroup()
                    .add(new LabelTr("gui.misca.charsheet.wiki")).size(30, lineHeight).below().move(0, 4, 0)
